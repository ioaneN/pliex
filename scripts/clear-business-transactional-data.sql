-- One-shot cleanup: Gizmo snapshots/connection + sales/expenses/inventory/automations.
...
begin
  delete from public.gizmo_sync_snapshots where business_id = bid;
  delete from public.gizmo_connections where business_id = bid;
